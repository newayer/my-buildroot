...
ifeq ($(BR2_PACKAGE_INIT_SCRIPT_NET_FORWARD),y)

define INSTALL_NET_FORWARD_INIT_SYSV
	$(INSTALL) -m 755 -D $(INIT_SCRIPTS_PKGDIR)files/forward/S42forward $(TARGET_DIR)/etc/init.d/S42forward
	$(INSTALL) -m 644 -D $(INIT_SCRIPTS_PKGDIR)files/forward/sysctl.conf $(TARGET_DIR)/etc/sysctl.conf
endef
